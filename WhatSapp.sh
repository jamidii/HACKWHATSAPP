...
echo "GITHUB  : GITHUB.COM/FAJAR-24"|lolcat
echo " JANGAN DI RECODE YA NJINK "|lolcat
echo "##########################################"|lolcat
echo "HACK CHATAN PACAR"|lolcat
echo ""
echo -n $cy"Ini Isi Nomor PACAR KAMU:"
read tr
echo "============================" | lolcat
...
figlet "5"|lolcat
clear
echo "*TUNGGU SEBENTAR HAMPIR BERHASIL"|lolcat
...
echo "PACAR MU : UDAH. EMNG KNP?"|lolcat
echo "TEMAN MU : KAMU MAU GK JADI PACAR AKU "|lolcat
echo "PACAR MU : HMM.."|lolcat
echo "TEMAN MU : PLEASE"|lolcat
echo "TEMAN MU : PUTUSIN AJH PACAR KAMUNYA.TRUS KAMU JADI PACARKU"|lolcat
echo "PACAR MU : YAUDAH IYA NANTI AKU PUTUSIN PACAR AKU"|lolcat
echo "TEMAN MU : IYH SAYANG"|lolcat
echo "PACAR MU : OK SAYANG.LGI APA"|lolcat
echo "TEMAN MU : LGI TIDURAN SAYANGG"|lolcat
echo "PACAR MU : OHW.MAKAN BELUM SAYANG ?"|lolcat
...
echo "DAN PUNYA MANTAN BANYAK"|lolcat
figlet "W A R I N G"|lolcat
